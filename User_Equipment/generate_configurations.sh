...
update_conf configs/ue1.conf "rf" "device_args" "tx_port=tcp://127.0.0.1:2101,rx_port=tcp://127.0.0.1:2100,base_srate=23.04e6"
...
update_conf configs/ue1.conf "rat.eutra" "nof_carriers" "0"
...
update_conf configs/ue1.conf "pcap" "mac_filename" "logs/ue_mac.pcap"
update_conf configs/ue1.conf "pcap" "mac_nr_filename" "logs/ue_mac_nr.pcap"
update_conf configs/ue1.conf "pcap" "nas_filename" "logs/ue_nas.pcap"

# Update configuration values for Logging
update_conf configs/ue1.conf "log" "all_level" "info"
update_conf configs/ue1.conf "log" "phy_lib_level" "none"
update_conf configs/ue1.conf "log" "all_hex_limit" "32"
update_conf configs/ue1.conf "log" "filename" "logs/ue.log"
update_conf configs/ue1.conf "log" "file_max_size" "-1"

# Update configuration values for Metrics
update_conf configs/ue1.conf "general" "metrics_csv_enable" "true"
update_conf configs/ue1.conf "general" "metrics_period_secs" "1"
update_conf configs/ue1.conf "general" "metrics_csv_filename" "logs/ue_metrics.csv"
#update_conf configs/ue1.conf "general" "have_tti_time_stats" "true"
update_conf configs/ue1.conf "general" "tracing_enable" "true"
update_conf configs/ue1.conf "general" "tracing_filename" "logs/ue_tracing.log"
