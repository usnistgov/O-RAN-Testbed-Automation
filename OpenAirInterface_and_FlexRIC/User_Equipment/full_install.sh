...
# Guide: https://gitlab.eurecom.fr/oai/openairinterface5g/-/blob/develop/doc/BUILD.md
...
if [ -f "openairinterface5g/cmake_targets/ran_build/build/nr-softmodem" ] && [ -f "openairinterface5g/cmake_targets/ran_build/build/nr-uesoftmodem" ]; then
...
# Code from (https://gitlab.eurecom.fr/oai/openairinterface5g/-/blob/develop/doc/NR_SA_Tutorial_COTS_UE.md#32-build-oai-gnb):
