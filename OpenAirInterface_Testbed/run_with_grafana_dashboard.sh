...
trap 'trap - EXIT SIGINT SIGTERM; "$SCRIPT_DIR/RAN_Intelligent_Controllers/Flexible-RIC/./stop_grafana.sh"; "$SCRIPT_DIR/./stop.sh"; stty sane; exit' EXIT SIGINT SIGTERM
