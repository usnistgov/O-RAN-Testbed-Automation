...
kpi_metrics_path = selectFile(r'KPI_Metrics[_\.]?(.*)\.csv', True)
print('Selected:', kpi_metrics_path)
print()

print('Selecting Jamming_Metrics file...')
jamming_metrics_path = selectFile(r'Jamming_Metrics_.*\.csv', True)
...
output_file_name = f'Labeled_KPI_Metrics_{append_date}.csv'
...
output_file.close()
print('Successfully zipped KPI_Metrics and Jamming_Metrics data into:', output_file_name)
