...
if [ ! -f "examples/xApp/c/monitor/xapp_gtp_mac_rlc_pdcp_moni.c.previous" ]; then
    ...
    cp examples/xApp/c/monitor/xapp_gtp_mac_rlc_pdcp_moni.c.previous "$PARENT_DIR/install_patch_files/flexric/add_e2_idpp/c/monitor/xapp_gtp_mac_rlc_pdcp_moni.previous.c"
fi
if [ ! -f "examples/xApp/c/monitor/xapp_rc_moni.c.previous" ]; then
    ...
    cp examples/xApp/c/monitor/xapp_rc_moni.c.previous "$PARENT_DIR/install_patch_files/flexric/add_e2_idpp/c/monitor/xapp_rc_moni.previous.c"
fi
if [ ! -f "examples/xApp/c/orange/xapp_es_with_cell_util.c.previous" ]; then
    ...
    cp examples/xApp/c/orange/xapp_es_with_cell_util.c.previous "$PARENT_DIR/install_patch_files/flexric/add_e2_idpp/c/orange/xapp_es_with_cell_util.previous.c"
fi
if [ ! -f "examples/xApp/c/slice/xapp_slice_moni_ctrl.c.previous" ]; then
    ...
    cp examples/xApp/c/slice/xapp_slice_moni_ctrl.c.previous "$PARENT_DIR/install_patch_files/flexric/add_e2_idpp/c/slice/xapp_slice_moni_ctrl.previous.c"
fi
if [ ! -f "examples/xApp/c/tc/xapp_tc_all.c.previous" ]; then
    ...
    cp examples/xApp/c/tc/xapp_tc_all.c.previous "$PARENT_DIR/install_patch_files/flexric/add_e2_idpp/c/tc/xapp_tc_all.previous.c"
fi
if [ ! -f "src/xApp/act_proc.c.previous" ]; then
    cp src/xApp/act_proc.c src/xApp/act_proc.c.previous
    cp src/xApp/act_proc.c.previous "$PARENT_DIR/install_patch_files/flexric/add_e2_idt_proc.previous.c"
fi
if [ ! -f "src/xApp/act_proc.h.previous" ]; then
    cp src/xApp/act_proc.h src/xApp/act_proc.h.previous
    cp src/xApp/act_proc.h.previous "$PARENT_DIR/install_patch_files/flexric/add_e2_idt_proc.previous.h"
fi
if [ ! -f "src/xApp/e42_xapp_api.h.previous" ]; then
    cp src/xApp/e42_xapp_api.h src/xApp/e42_xapp_api.h.previous
    cp src/xApp/e42_xapp_api.h.previous "$PARENT_DIR/install_patch_files/flexric/add_e2_id2_xapp_api.previous.h"
fi
if [ ! -f "src/xApp/msg_dispatcher_xapp.c.previous" ]; then
    ...
    cp src/xApp/msg_dispatcher_xapp.c.previous "$PARENT_DIR/install_patch_files/flexric/add_e2_idg_dispatcher_xapp.previous.c"
fi
if [ ! -f "src/xApp/msg_dispatcher_xapp.h.previous" ]; then
    ...
    cp src/xApp/msg_dispatcher_xapp.h.previous "$PARENT_DIR/install_patch_files/flexric/add_e2_idg_dispatcher_xapp.previous.h"
fi
if [ ! -f "src/xApp/msg_handler_xapp.c.previous" ]; then
    cp src/xApp/msg_handler_xapp.c src/xApp/msg_handler_xapp.c.previous
    cp src/xApp/msg_handler_xapp.c.previous "$PARENT_DIR/install_patch_files/flexric/add_e2_idg_handler_xapp.previous.c"
fi
git apply --verbose --ignore-whitespace "$PARENT_DIR/install_patch_files/flexric/add_e2_id"
cd "$PARENT_DIR"
