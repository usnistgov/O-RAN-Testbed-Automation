...
echo "" >>download_dependency_repositories.bat
echo "REM This script will download the 5G_Core_Network, gNodeB, User_Equipment, and RAN_Intelligent_Controllers repositories for analyzing the source code without requiring a full testbed build and installation." >>download_dependency_repositories.bat
echo "" >>download_dependency_repositories.bat
...
# Using the function to generate commands for each repository
