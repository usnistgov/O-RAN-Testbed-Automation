...
|----------|-------------|
| **OCUDU gNB with N UEs, Grafana Traffic Monitoring** | Deploy the OCUDU testbed, generate traffic from multiple UEs, collect Prometheus metrics, and visualize network performance using Grafana dashboards. |
