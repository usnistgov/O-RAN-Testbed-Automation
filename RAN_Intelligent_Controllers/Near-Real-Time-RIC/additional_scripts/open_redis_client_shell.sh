...
echo -e "  GET <key-name>\t\tRetrieves the value of a specific key"
echo -e "  HGETALL <key-name>\tRetrieves all fields and values of a hash key"
echo -e "  LRANGE <list-name> 0 -1\tLists all elements in a list"
echo -e "  SADD <set-name> <value>\tAdds a value to a set"
echo -e "  SMEMBERS <set-name>\tLists all members of a set"
