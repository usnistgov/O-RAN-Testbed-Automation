...
sudo setsid bash -c "stdbuf -oL -eL sudo sudo ./nr-uesoftmodem -O "$SCRIPT_DIR/configs/ue$UE_NUMBER.conf" --rfsim --rfsimulator.serveraddr 127.0.0.1 -r 106 --numerology 1 --band 78 -C 3619200000 > \"$SCRIPT_DIR/logs/ue${UE_NUMBER}_stdout.tx\" 2>&1" </dev/null &
cd "$SCRIPT_DIR"
